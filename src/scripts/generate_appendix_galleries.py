...
GALLERY: list[tuple] = [
    # ---- Base Random generator (no geometric validation) ----
    # Same grids as the Constrained Random rows below, but validate_geometry=False:
    # lasers may point immediately off-grid or have zero-length beams, so a laser
    # source can be present yet produce no active beam (it then behaves like a wall).
    ("01_random_3x3_2a_1L",
     "random",
