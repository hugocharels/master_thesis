...
All experiments are reproducible from a single Python source tree, available at
#link("https://github.com/hugocharels/master_thesis"). The relevant versions and
